	        ...
	        $soapHeader = '
				...
				xmlns:u="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd">
				  <s:Header>
					...
					<a:MessageID>
					urn:uuid:'.OnlineFederationManager::gen_uuid().'</a:MessageID>
					<a:ReplyTo>
					  <a:Address>
					...
					xmlns:o="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd">
					  <u:Timestamp u:Id="_0">
						<u:Created>'.  OnlineFederationManager::getCurrentTime().'Z</u:Created>
						<u:Expires>'.OnlineFederationManager::getNextDayTime().'Z</u:Expires>
					  </u:Timestamp>

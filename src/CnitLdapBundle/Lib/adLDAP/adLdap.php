...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@cnit.com";
    ...
    * @var string
    */
	protected $baseDn = "DC=cnit,DC=com";
    ...
    * @var string
    */
	protected $topBaseDn = "DC=cnit,DC=com";
    ...
    * @var array
    */
    protected $domainControllers = array("cnit.com");
    ...
    */
    ...
    {
        $this->setAdminUsername($this -> adminUsername);
        $this->setAdminPassword($this -> adminPassword);
        $this->setPort($this -> getPort());
        $this->setAccountSuffix($this -> getAccountSuffix());
        $this->setBaseDN($this -> getBaseDn());
        $this->setDomainControllers($this -> domainControllers);
